function [in, out, opt] = analysis_timelock(in, out, opt)
% Computes the covariance matrix
%
% SYNTAX:
% [IN,OUT,OPT] = ANALYSIS_TIMELOCK(IN,OUT,OPT)
%
...
%
%   data
%   (string, default 'timelock.mat')
%   file name for the timelocked analysis
%
% opt           
%   (structure) with the following fields. 
%
...
%       ft_timelockanalysis. The entire struct is passed through except
...
%% Options
fields   = {'timelock_analysis','flag_verbose' , 'flag_test' , 'folder_out' };
...
if isempty(out.data)
    out.vol = cat(2, opt.folder_out, filesep, 'timelock.mat');
end
...
% Copy parameters
cfg = opt.timelock_analysis;
[data] = ft_timelockanalysis(cfg, data_in.data);
