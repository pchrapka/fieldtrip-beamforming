function obj = get_aal_coarse_27(obj,varargin)
%GET_AAL_COARSE_27 adds patches for the AAL coarse 27 configuration
%   GET_AAL_COARSE_27(...) returns a coarse partition of the AAL
%   atlas into 27 patches
%
%   Parameters
%   ----------
...
p = inputParser;
addParameter(p,'split_lpfc',false,@islogical);
...
switch p.Results.split_lpfc
    case true
        flag_split_lpfc = true;
    case false
        flag_split_lpfc = false;
    otherwise
        error('unknown split lpfc option %s',p.Results.split_lpfc);
end
